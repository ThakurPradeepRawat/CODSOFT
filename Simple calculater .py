...
def calculate_percentage():
    ...
    try:
        ...
        equation = str(percentage_result)
        label_result.config(text=equation)
    except:
...
Button(root, text="%", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#2a2d36",
       command=lambda: calculate_percentage()).place(x=290, y=100)
Button(root, text="/", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#2a2d36",
...
Button(root, text="X", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#2a2d36",
       command=lambda: show("X")).place(x=290, y=500)
