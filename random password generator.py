...
WeakradioButton = Radiobutton(root, text='Medium', value=2, variable=choice,font=Font)
WeakradioButton .grid(pady=5)

WeakradioButton = Radiobutton(root, text='Strong', value=3, variable=choice,font=Font)
WeakradioButton .grid(pady=5)

lengthLabel = Label(root, text='Password length ', font= Font, bg='grey20', fg='white')
lengthLabel.grid(pady=5)

length_Box=Spinbox(root,from_=6, to_=18,width=6,font=Font)
